...
<div style="display: flex; flex-direction: column; align-items: center;">
  <div style="transform: scale(0.2); transform-origin: top left; width: 400px; height: 210px;">
  ...
  <div style="transform: scale(0.2); transform-origin: top left; width: 400px; height: 210px; margin-top: 10px;">
